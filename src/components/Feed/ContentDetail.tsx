...
const ContentDetail: React.FC<ContentDetailProps> = ({
  ...
  return (
    <div
      className="fixed top-[6px] right-[6px] bottom-[6px] left-[calc(4rem+6px)] bg-primary z-50 rounded-2xl shadow-sm border border-primary transition-[transform,opacity] duration-300"
      style={{
        transform: isVisible
    ...
    >
      {isLoading ? (
        ...
        <>
          {/* Header */}
          <div
            className="flex items-center justify-between p-6 border-b border-primary transition-[transform,opacity] duration-300"
            style={{
          ...
          <div className="h-full overflow-y-auto">
            ...
            {/* Footer */}
            <div
              className="border-t border-primary p-6 transition-[transform,opacity] duration-300"
              style={{
                transform: isVisible ? 'translateY(0)' : 'translateY(20px)',
                opacity: isVisible ? 1 : 0,
                transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)',
