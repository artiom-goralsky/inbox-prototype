        ...
        <div className="flex items-center flex-1 justify-center max-w-xl mx-4">
          <div className="relative w-full max-w-[340px]">
            ...
            <TextInput
              ...
              className="w-full pl-10 pr-4 py-2 text-sm text-tertiary rounded-lg placeholder-[gray-500] border border-primary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
        </div>
